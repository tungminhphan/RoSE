...
def write_info(out_file, t, trace):
    ...
    # print the lead agent state
    out_file.write("LEAD AGENT STATE: \n")
...
def print_all_agents_at_time_t(filename, outfile, time_step=None):
    ...
    for agent_id, agent_trace in agent_dict.items():
        ...
        #out_file.write("ACTUAL VELOCITY: \n")
        #out_file.write(str(agent_trace['lead_agent']) + '\n')

        out_file.write("VELOCITY ESTIMATE: \n")
        out_file.write(str(agent_trace['unc_velocity']) + '\n')

        # print the lead agent state
        out_file.write("LEAD AGENT: \n")
        out_file.write(str(agent_trace['lead_agent']) + '\n')
        out_file.write("LEAD AGENT STATE: \n")
        out_file.write(str(agent_trace['lead_agent_state']) + '\n')
...
if __name__ == '__main__':
    ...
    #print_one_agent_trace(traces_file, 24 ,65, 'east', 76, outfile)
